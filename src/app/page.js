...
export default function Home() {
  return (
    <main className='p-4 bg-gray-100 h-screen'>
      ...
      <p>
        Find your way to the <a className='text-blue-500 hover:underline' href='https://www.notion.so/sprintocom/Onboarding-Checklist-Frontend-0d2d0cc032234227933a3e353946fdb6' target='_blank' rel="noopener noreferrer">Notion Doc here</a> 
        - for the onboarding checklist. This will help you get started with the project.
      </p>

      <div className='mt-4'>
        <div className='mb-2'>
          Find some of the important links here, this is where you&#39;ll be working on the exercises. 
          You can find the links in the code inside the <code>src/app</code> folder. For instance, the React primer exercise can be found inside <code>src/app/react-primer</code>.
        </div>
